...
const Movie = (props: MovieProps) => {
  ...
  const scroll = (d: number) => {
    scrollT(d)
    props.update('Movie', carouselOption.cur)
  }
  ...
  return (
    <div class='flex relative flex-col w-full'>
      <div class='flex flex-row gap-4 w-full'>
        <div class='w-[5%]' />
        <div class='text-2xl font-semibold leading-normal'>{props.t('Movie')}</div>
      ...
      <div class='flex flex-row w-full h-[21rem]'>
        ...
        <div class='w-[5%] right-0 absolute h-72 flex flex-col gap-9 items-center justify-center'>
